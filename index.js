...
const invocationName = "say pay";
const transfer = require("./transfer");

const languageStrings = {
   'en': {
        'translation': {
            'WELCOME1' : 'Welcome to say pay!',
            'WELCOME2' : 'Greetings!',
...
const handlers = {
    'PayIntent': function () {
        ...
        let amount = slotValues.amount.resolved;
        let recipient = slotValues.recipient.resolved;
        
        let speechOutput = "";
        
        if (this.event.request.intent.confirmationStatus === "DENIED") {
            speechOutput = "Okay. I won't send anything.";
            ...
            transfer(recipient, amount, () => {
                speechOutput = `Okay. I sent ${amount} dollars to ${recipient}. Lucky ${recipient}!`;
...
var interactionModel = [
  {
    ...
    "samples": [
      "tip {amount} dollars to {recipient}",
      "give {amount} dollars to {recipient}",
      "transfer {amount} dollars to {recipient}",
